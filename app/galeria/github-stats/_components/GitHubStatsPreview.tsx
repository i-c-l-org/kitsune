...
/**
 * GitHubStatsPreview – Componente de pré-visualização para GitHub Stats SVG.
 *
 ...
 * pela própria API do Kitsune (/api/github-stats/preview/[theme]). O conteúdo
  ...
  return (
    <div className="previewFlexCol">
      <div className="previewSectionHeader">
        <div className="previewSectionIconBox">
          <i className="fas fa-chart-line" />
        </div>
        <div>
          <h2 className="previewSectionTitle2">GitHub Stats</h2>
          <p className="previewSectionDesc">
            Prévia de commits, PRs e contribuições em tempo real
          </p>
        </div>
      </div>
      ...
      <div className="previewSettingsPanel">
        ...
        <div className="previewSettingsGrid">
          <div className="previewSettingsFieldFull">
            <label className="previewFieldLabel" htmlFor="stats-username">
          ...
          <div>
            <label className="previewFieldLabel" htmlFor="stats-width">
          ...
          <div>
            <label className="previewFieldLabel" htmlFor="stats-height">
